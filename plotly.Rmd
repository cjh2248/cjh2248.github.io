...
```{r}
filtered_inspections <- nyc_inspections %>%
  filter(boro == "Manhattan")

plot_ly(filtered_inspections, x = ~score, type = "histogram", histnorm = "density") %>%
  layout(
    title = "Density Plot of NYC Restaurant Inspection Scores in Manhattan",
